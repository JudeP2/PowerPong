...
function love.draw()
    ...
    elseif gameState == 'done' or player1score == 1 and player2Score == 10 or player2score == 1 and player1Score == 10 then
        -- UI messages
    ...
    elseif player2Score == player1Score then
        ...
        --handicap/debuff 1 paddle speed (Jude Piacentino/Isaac Pointer)
    ...
    --Power-up that increases paddle size (Zamir)
    if player1Score <= player2Score - 3 then
        player1.height = 50
        love.graphics.setColor(255, 0, 0,255)
        love.graphics.printf('Player 1 now has a larger paddle!', 0, 220, VIRTUAL_WIDTH, 'center')
    elseif player1Score == player2Score then
        player1.height = 20
    end
    if player2Score <= player1Score - 3 then
        player2.height = 50
        love.graphics.setColor(255, 0, 0,255)
        love.graphics.printf('Player 2 now has a larger paddle!', 0, 220, VIRTUAL_WIDTH, 'center')
    elseif player2Score == player1Score then
        player2.height = 20
    end
    
    
    -- Paddle size decrease handicap (Zamir)
    if player2Score <= player1Score - 6 then
        player1.height = 15
        love.graphics.setColor(255, 0, 0,255)
        love.graphics.printf('Handicap! Player 1 now has a smaller paddle!', 0, 230, VIRTUAL_WIDTH, 'center')
    elseif player1Score == player2Score then
        player1.height = 20
    end
    if player1Score <= player2Score - 6 then
        player2.height = 15
        love.graphics.setColor(255, 0, 0,255)
        love.graphics.printf('Handicap! Player 2 now has a smaller paddle!', 0, 230, VIRTUAL_WIDTH, 'center')
    elseif player2Score == player1Score then
        player2.height = 20
    end
    ...
    -- (therefore only can occur once when its 0-9) (Jude Piacentino/Isaac Pointer)
